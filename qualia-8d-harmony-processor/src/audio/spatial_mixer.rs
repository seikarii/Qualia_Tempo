...
impl SpatialMixerConfig {
    ...
    pub fn default_8d(sample_rate: u32) -> Self {
        Self {
            limiter_threshold: 0.92,  // CORRECTED: Reduced from 0.99 to increase crest factor (less crushing)
            num_stems: 4,
            lookahead_ms: 5.0,
            release_ms: 50.0,
            knee_db: 2.5,             // CORRECTED: Increased from 1.5 for smoother limiting
            sample_rate,
        }
    }
}
