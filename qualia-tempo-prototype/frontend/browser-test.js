...
async function comprehensiveTest() {
  ...
  try {
    ...
    await page.screenshot({
      path: "debug-screenshot-main-menu.png",
      fullPage: true,
    });
    ...
    fs.writeFileSync(
      "browser-test-report-main-menu.json",
      JSON.stringify(report1, null, 2),
    );
    console.log(
      "📊 Main menu report saved: browser-test-report-main-menu.json",
    );
    ...
    await page.screenshot({
      path: "debug-screenshot-game-view.png",
      fullPage: true,
    });
    ...
    fs.writeFileSync(
      "browser-test-report-game-view.json",
      JSON.stringify(report2, null, 2),
    );
    console.log(
      "📊 Game view report saved: browser-test-report-game-view.json",
    );
    ...
    console.log(
      `Overall status: ${errors.length === 0 ? "✅ Success" : "❌ Errors found"}`,
    );
